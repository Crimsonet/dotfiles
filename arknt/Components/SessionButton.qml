    ...
    ComboBox {
        ...
        delegate: ItemDelegate {
            ...
            contentItem: Text {
                ...
                color: selectSession.highlightedIndex === index ? root.palette.highlight.hslLightness >= 0.7 ? "#545454" : "white" : root.palette.window.hslLightness >= 0.8 ? root.palette.highlight.hslLightness >= 0.8 ? "#545454" : root.palette.highlight : "white"
